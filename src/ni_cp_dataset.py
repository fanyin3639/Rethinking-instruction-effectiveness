...
class NIConfig(datasets.BuilderConfig):
    def __init__(self, *args, task_dir=None, max_num_instances_per_task=None, max_num_instances_per_eval_task=None, specific_task=None, do_eval=False, **kwargs):
...
class NaturalInstructions(datasets.GeneratorBasedBuilder):
    ...
    def _generate_examples(self, path=None, task_dir=None, max_num_instances_per_task=None, subset=None, specific_task=None, do_eval=False):
        """Yields examples."""
                ...
                with open(task_path, encoding="utf-8") as task_f:
                    ...
                    if subset == "test":
                        ...
                        if do_eval:
                            ...
                            instances = all_instances[100:200]
                    else:
